...
import { MaterialPane } from "../src/renderer/src/course/material";
...
describe("Brief composition boundary", () => {
  ...
  it("keeps ordinary course documents as the default and confines composed content to Brief", () => {
    ...
    const preview = render(createElement("p", null, "Development-only response area"));
