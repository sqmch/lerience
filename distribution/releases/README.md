...
pull request that updates `package.json`. The desktop release-candidate workflow refuses a tag with
...
release notes. Name any omitted platform or architecture and any pending native acceptance. The
file's trimmed text is embedded in the one signed manifest and copied unchanged into the public
release bundle.
