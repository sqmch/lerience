...
| 12 | LB-015, interactive reading | [Production work](reading-production-2026-09-26.md): portable optional marks for new courses, contextual-only controls, engine authority under ADR-045. Validation in progress. |
...
| [LB-015](experience.md#lb-015) | Save and return to Lesson passages | Optional reading | P3 | [Production work](reading-production-2026-09-26.md); owner task `01a0ddfc`, branch `codex/lb-015-new-course-highlights`; no existing-course conversion or release | S15 | In progress |
