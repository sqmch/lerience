...
| 8 | LB-007, then LB-008, tutor controls | LB-007 implemented in [PR #97](https://github.com/sqmch/lerience/pull/97), merged at `4b0e5b0` after green final-head Windows CI. LB-008 is the active implementation on `codex/lb-008-model-before-opener`. |
...
| [LB-008](providers.md#lb-008) | Choose a model before the first session work | Feature | P2 | Shared pre-turn gate; conductor and native first-turn evidence | S08 | In progress |
